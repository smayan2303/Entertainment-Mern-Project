...
const BookSingleCard = ({ book }) => {
  return (
    <div className="border-2 border-gray-500 rounded-lg px-4 py-2 m-4 relative hover:shadow-xl transition duration-300 ease-in-out transform hover:scale-105">
      ...
      <div className="flex justify-between items-center gap-x-4 mt-4 p-4">
        <Link to={`/books/details/${book._id}`}>
          <BsInfoCircle className="text-2xl text-green-800 hover:text-green-500 transition duration-200" />
        </Link>
